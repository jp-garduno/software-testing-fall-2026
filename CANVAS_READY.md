# ✅ Canvas Instructions Ready!

**Status**: All Canvas materials prepared with your GitHub username  
...
- Week 2, Session 4: Testing Pyramid & Principles (4 hours)
- Week 3, Session 5: Static Testing Setup (4 hours)
...
- ✅ Time estimates
- ✅ Self-check lists
- ✅ Your GitHub URLs already populated
...
2. Repository name: `software-testing-fall-2026`
3. Description: "Software Testing Course - Fall 2026"
4. Public or Private: **Public** (so students can clone)
...
git init
git add .
git commit -m "chore: initial course setup with modules 1-3 complete"
git branch -M main
git remote add origin https://github.com/jp-garduno/software-testing-fall-2026.git
git push -u origin main
```

### Step 3: Set Up Canvas (60 minutes)
...
4. Set up gradebook categories

### Step 4: Test Everything (20 minutes)

1. Click all GitHub links in Canvas
2. Clone the repository yourself
3. Try submitting a test homework
4. Verify automated grading works
...
- [ ] **Push code to GitHub** (2 min)
  ...
  git init
  git add .
  git commit -m "chore: initial course setup"
  git remote add origin https://github.com/jp-garduno/software-testing-fall-2026.git
  git push -u origin main
  ```
...
- [ ] **Send welcome email** (optional)
  - Let students know course starts
...
- ✅ 2 homeworks completed (HW1, HW2)
- ✅ Experience with automated grading
- ✅ Ready for in-person Week 4
...
- 🤖 Automated grading configured
- 🎓 Student guides prepared
- 🔗 All GitHub URLs updated

**Next step**: Push to GitHub and set up Canvas!

**Good luck with your course!** 🚀

---

**Questions?** Check the documentation in `docs/instructor/` or review this file.
