# Exercise 1: Conventional Commits Practice

**Time**: 20 minutes  
**Objective**: Write proper conventional commit messages
...
## Part 4: Complete Commit Messages

Write complete commit messages (with body and footer) for:

**Scenario**: You implemented JWT token authentication. This replaces the old session-based authentication. Closes issue #123.
...
See [answers file](./01-answers.md) or discuss in class.
